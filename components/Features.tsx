  ...
  return (
    <div className="relative z-20 py-10 lg:py-10 max-w-7xl mx-auto">
      <div className="px-8">
        ...
        From stock graph creation to dynamic visualization, Everything Technology offers APIs for virtually every aspect. It can even generate website content specifically tailored to showcase your stock data.
        </p>
      </div>
      ...
      <div className="w-full mx-auto bg-transparent dark:bg-transparent group h-full">
        <div className="flex flex-1 w-full h-full flex-col space-y-2  relative">
          <Image
            ...
            width={1300}
            height={500}
            className="h-[60%] w-full aspect-square object-cover object-center rounded-sm blur-none group-hover/image:blur-md transition-all duration-200 mt-4"
          />
        </div>
      </div>
    </Link>
...
export const SkeletonTwo = () => {
  ...
  return (
    <div className="relative flex flex-col items-start p-2 gap-10 h-[80%] overflow-hidden">
      {/* TODO */}
...
export const SkeletonFour = () => {
  return (
    <div className="h-60 md:h-60 flex flex-col items-center relative bg-transparent dark:bg-transparent mt-10">
      <Globe className="absolute -right-10 md:-right-10 -bottom-80 md:-bottom-72 mt-10" />
    </div>
  );
};
